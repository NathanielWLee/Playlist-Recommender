...
import random
import requests
from .models import SpotifyToken#, access_token, user # you will need this in home page? to call this function
# import token, user,  lex_response when available

# All of this should ideally be in a function, we read in user 

# when calling, pass in token, user, lex_response (whatever the variable name is)
def create_playlist(token, user_id):#, lex_response):
...
# create_playlist(SpotifyToken.access_token, SpotifyToken.user)
